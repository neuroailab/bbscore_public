...
from .dino_model import GroupNormalize, DINOV2_LSTM_MODEL, load_model
...
class DINOV2_LSTM:
    ...
    def __init__(self):
        ...
        self.model_mappings = {
            "DINOV2_LSTM": "gs://stanford_neuroai_models/lstm_models/dino_lstm.pt",
        }
