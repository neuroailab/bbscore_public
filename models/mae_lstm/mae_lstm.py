...
from .mae_model import GroupNormalize, MAE_LSTM_MODEL, load_model
...
class MAE_LSTM:
    ...
    def __init__(self):
        ...
        self.model_mappings = {
            "MAE_LSTM": "gs://stanford_neuroai_models/lstm_models/mae_lstm.pt",
        }
        # MAE normalization values
        self.static = False
        self.fps = 1000 / 60
        self.processor = transform_img = T.Compose([T.Resize(256),
                                                    T.CenterCrop(224),
                                                    T.ToTensor(),
