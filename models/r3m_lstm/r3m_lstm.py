...
from .r3m_model import R3M_LSTM_MODEL, load_model
...
class R3M_LSTM:
    """Loads pre-trained R3M self-supervised vision models."""

    def __init__(self):
        """Initializes the R3M loader."""
        self.model_mappings = {
            "R3M_LSTM_PHYS": "gs://stanford_neuroai_models/lstm_models/r3m_lstm_physion.pt",
            "R3M_LSTM_EGO4D": "gs://stanford_neuroai_models/lstm_models/r3m_lstm_ego4d.pt",
        }
        # R3M normalization values
        self.static = False
        self.fps = 1000/60
    ...
    def get_model(self, identifier):
        """
        Loads a R3M model based on the identifier.

        Args:
            identifier (str): Identifier for the R3M variant.

        Returns:
            model: The loaded R3M model.
    ...
    def postprocess_fn(self, features_np):
        """Postprocesses R3M model output by flattening features.

        Args:
            features_np (np.ndarray): Output features from R3M model
                as a numpy array.
