...
class CONVLSTM:
    ...
    def __init__(self):
        ...
        self.model_mappings = {
            "CONVLSTM": {"model": "https://github.com/chengtan9907/OpenSTL/releases/download/kitti-weights/kitticaltech_convlstm_one_ep100.pth",
                         "config": "models/convlstm/convlstm_config.py"
                         }
        }
